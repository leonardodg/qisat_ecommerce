...
use App\Model\Table\EcmLogAcaoTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\EcmLogAcaoTable Test Case
 */
class EcmLogAcaoTableTest extends TestCase
{

    /**
     * Test subject     *
     * @var \App\Model\Table\EcmLogAcaoTable     */
    public $EcmLogAcao;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EcmLogAcao') ? [] : ['className' => 'App\Model\Table\EcmLogAcaoTable'];        $this->EcmLogAcao = TableRegistry::get('EcmLogAcao', $config);    }
