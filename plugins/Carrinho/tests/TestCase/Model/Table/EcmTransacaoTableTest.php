...
use Carrinho\Model\Table\EcmTransacaoTable;

/**
 * Carrinho\Model\Table\EcmTransacaoTable Test Case
 */
class EcmTransacaoTableTest extends TestCase
{

    /**
     * Test subject     *
     * @var \Carrinho\Model\Table\EcmTransacaoTable     */
    public $EcmTransacao;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EcmTransacao') ? [] : ['className' => 'Carrinho\Model\Table\EcmTransacaoTable'];        $this->EcmTransacao = TableRegistry::get('EcmTransacao', $config);    }
