...
use Carrinho\Model\Table\EcmAgendamentoProdutoTable;

/**
 * Carrinho\Model\Table\EcmAgendamentoProdutoTable Test Case
 */
class EcmAgendamentoProdutoTableTest extends TestCase
{

    /**
     * Test subject     *
     * @var \Carrinho\Model\Table\EcmAgendamentoProdutoTable     */
    public $EcmAgendamentoProduto;
     ...
     */
    public $fixtures = [
        'plugin.carrinho.ecm_agendamento_produto',
        ...
        'plugin.carrinho.mdl_user_endereco',
        ...
        'plugin.carrinho.ecm_forma_pagamento',
        'plugin.carrinho.ecm_tipo_pagamento',
        'plugin.carrinho.ecm_transacao',
        'plugin.carrinho.ecm_transacao_status',
        'plugin.carrinho.ecm_venda_boleto',
        'plugin.carrinho.ecm_curso_presencial_email_confirmacao',
        'plugin.carrinho.ecm_produto',
        'plugin.carrinho.ecm_tipo_produto',
        'plugin.carrinho.mdl_course',
        'plugin.carrinho.mdl_enrol',
        ...
        'plugin.carrinho.ecm_produto_pacote',
        'plugin.carrinho.ecm_produto_prazo_extra'
    ];
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EcmAgendamentoProduto') ? [] : ['className' => 'Carrinho\Model\Table\EcmAgendamentoProdutoTable'];        $this->EcmAgendamentoProduto = TableRegistry::get('EcmAgendamentoProduto', $config);    }
    ...
    {
        unset($this->EcmAgendamentoProduto);
