Parabéns <b> <?= $usuario->firstname.' '.$usuario->lastname?> </b>,<br/>
<br/>
Seu pedido <b><?= $pedido?></b> foi efetuado com sucesso!
...
<ul>
    <li>
    Nós, da AltoQi e QiSat, estamos felizes com a sua aquisição. <br>
    </li>
    <li>
    <?= $usuario->firstname ?> </b>, conte conosco para ajudar você neste mercado tão desafiador e gratificante da construção civil. <br>
    </li>

    <li>
         Em breve, nossa equipe comercial entrará em contato para confirmar seus dados de compra e garantir que a sua escolha foi a melhor solução. <br>
    </li>

    <li>
    Durante esse contato é possível tirar possíveis dúvidas e agendar a data de início do curso, caso você tenha adquirido esse produto. <br>
    </li>
