...
class EcmVendaFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'pedido_status' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'ecm_carrinho_id' => ['type' => 'unique', 'columns' => ['ecm_carrinho_id'], 'length' => []],
