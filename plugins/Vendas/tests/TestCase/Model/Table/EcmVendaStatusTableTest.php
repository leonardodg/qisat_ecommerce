...
use Vendas\Model\Table\EcmVendaStatusTable;

/**
 * Vendas\Model\Table\EcmVendaStatusTable Test Case
 */
class EcmVendaStatusTableTest extends TestCase
{
    ...
    /**
     * Test subject     *
     * @var \Vendas\Model\Table\EcmVendaStatusTable     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('EcmVendaStatus') ? [] : ['className' => 'Vendas\Model\Table\EcmVendaStatusTable'];        $this->EcmVendaStatus = TableRegistry::get('EcmVendaStatus', $config);    }
