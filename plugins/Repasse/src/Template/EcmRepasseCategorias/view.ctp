<div class="ecmRepasseCategorias col-md-12">
    <h3><?= h($ecmRepasseCategoria->id) ?></h3>
    <table class="vertical-table">
        <tr>
            <th><?= __('Categoria') ?></th>
            <td><?= h($ecmRepasseCategoria->categoria) ?></td>
        </tr>
        <tr>
            <th><?= __('Id') ?></th>
        ...
        <tr>
            <th><?= __('Visivel') ?></th>
            <td><?= $this->Number->format($ecmRepasseCategoria->visivel) ?></td>
        </tr>
        <div class="related">
            <h4><?= __('Related Ecm Repasse') ?></h4>
            <?php if (!empty($ecmRepasseCategoria->ecm_repasse)): ?>
                <table cellpadding="0" cellspacing="0">
                    ...
                    <?php foreach ($ecmRepasseCategoria->ecm_repasse as $ecmRepasse): ?>
                        <tr>
