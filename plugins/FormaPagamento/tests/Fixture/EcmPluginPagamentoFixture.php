...
/**
 * EcmPluginPagamentoFixture
 *
 */
class EcmPluginPagamentoFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'ecm_plugin_pagamento';
    ...
    public $fields = [
        ...
        'habilitado' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => 'false', 'comment' => '', 'precision' => null],
        '_constraints' => [
