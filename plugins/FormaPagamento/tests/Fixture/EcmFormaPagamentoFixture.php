...
/**
 * EcmFormaPagamentoFixture
 *
 */
class EcmFormaPagamentoFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'ecm_forma_pagamento';
    ...
    public $fields = [
        ...
        'parcelas' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
