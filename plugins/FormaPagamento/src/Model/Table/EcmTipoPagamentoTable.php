...
use FormaPagamento\Model\Entity\EcmTipoPagamento;

/**
 * EcmTipoPagamento Model
 *
 * @property \Cake\ORM\Association\BelongsTo $EcmFormaPagamento */
class EcmTipoPagamentoTable extends Table
{
