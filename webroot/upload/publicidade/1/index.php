...
.Texto {
	padding: 8px 18px 8px 16px; font-size: 11px; color: #666666; line-height: 16px; FONT-FAMILY: Arial, Helvetica, sans-serif
}
.titulos {
	...
	<table cellSpacing=0 cellPadding=0 width=649 align=center border=0>
		...
		<tr>
			<td class="Texto" bgcolor="#FFFFFF">
					Destinado  aos profissionais que conhecem o cen&aacute;rio, aplica&ccedil;&otilde;es e vantagens do cabeamento  estruturado e desejam se capacitar na utiliza&ccedil;&atilde;o do software Lumine V4.
		  </TD>
		</tr>
		<tr>
			<td bgcolor="#FFFFFF">
        ...
        <tr>
          <td class="titulos" width="160" valign="top"><img height=19 width="125" src="<?php echo $linkConvite;?>images/tit_topico.gif" /><br /><br />
			...
			<span class="topicos">&#9679; </span>Lançamento dos pontos de dados e telecomunicações<br />
			<span class="topicos">&#9679; </span>Lançamento de eletrodutos e eletrocalhas<br />
			<span class="topicos">&#9679; </span>Definição gráfica de quadros (RACKS)<br />
			<span class="topicos">&#9679; </span>Dimensionamento das instalações <br />
			<span class="topicos">&#9679; </span>Dimensionamento dos eletrodutos <br />
			<span class="topicos">&#9679; </span>Geração de legendas, diagramas e detalhes <br />
			<span class="topicos">&#9679; </span>Geração de listas de materiais e mapa de cabos<br />
			<span class="topicos">&#9679; </span>Geração de plantas finais<br /></TD>
          <TD width=11>&nbsp;</TD>
          <TD class="titulos" width="200" valign="top"><img height="17" width="67" src="<?php echo $linkConvite;?>images/tit_form.gif" /><br /><br />
			...
			<BR>
			<BR><img height="17" width="85" src="<?php echo $linkConvite;?>images/tit_certificado.gif" /><BR><BR>
            Com 75% de participação você recebe o certificado do curso até 30 dias após a data da edição.<BR><BR><BR>
        ...
        <TR>
          <td colspan="3" align="center"><a href="http://www.altoqi.com.br/software/projetos-eletricos/lumine-v4#overview-tab" target="_blank"><img width="203" height="35" border="0" alt="Conheça o Software" src="<?php echo $linkConvite;?>images/conheca.gif" ></a><a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=48<?php echo $info_curso_presencial;?>" target="_blank"><img width="204" height="35" border="0"  src="<?php echo $linkConvite;?>images/inscrevase.gif" ></a></td>
        </TR>
				</TABLE></TD>
		</TR>
		<tr bgcolor="#FFFFFF">
...
<MAP id=Map3 name=Map3>
	<AREA shape=RECT target=_blank coords=226,4,388,27
		href="<?php echo $linkCurso;?>">
	<AREA shape=RECT target=_blank coords=12,9,220,28
		href="http://www.altoqi.com.br/software/projetos-eletricos/lumine-v4#overview-tab">
</MAP>
