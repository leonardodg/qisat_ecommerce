...
.topicos {font-weight: bold; font-size: 11px; color: #0089E1; line-height: 16px; font-family: Arial, Helvetica, sans-serif;}
	...
	<table cellSpacing=0 cellPadding=0 width=649 align=center border=0>
		...
		<tr>
			<td width="200" rowspan="3" valign="top" bgcolor="#FFFFFF"><img
				...
				width="200" height="805" border="0" usemap="#Map2">
			</td>
			<td width="449" height="220" valign="top" bgcolor="#FFFFFF"><img
				...
				<table width="407" align="center">
					...
					<tr>
						...
						<td class="TxtCurso">Hydros V4</td>
					</tr>
					<tr>
		...
		<tr>
			<td class="Texto" bgcolor="#FFFFFF">
					Destinado a usuários iniciantes, este curso apresenta a tecnologia do sistema Incêndio do software AltoQi Hydros, abordando suas principais características, funções, ferramentas, recursos e demais possibilidades de utilização.
			</TD>
		</tr>
		<tr>
			<td bgcolor="#FFFFFF">
        ...
        <tr>
          <td class="titulos" width="160" valign="top"><img height=19 width="125" src="<?php echo $linkConvite;?>images/tit_topico.gif"/><br/><br/>
			  <span class="topicos">Hidrantes e Sprinklers</span><br/><br/>
			  <span class="topicos">&#9679; </span>Apresentação da filosofia de lançamento orientada ao projeto como um todo<br/>
			  <span class="topicos">&#9679; </span>Lançamento dos hidrantes e sprinklers<br/>
			  <span class="topicos">&#9679; </span>Apresentação da configuração que possibilita a adaptação de acordo com cada região<br/>
			  <span class="topicos">&#9679; </span>Definição dos hidrantes desfavoráveis<br/>
			  <span class="topicos">&#9679; </span>Dimensionamento da rede e da bomba de incêndio<br/>
			  <span class="topicos">&#9679; </span>Geração dos relatórios<br/>
		    <span class="topicos">&#9679; </span>Desenhos finais<br/></td>
          <td width=11>&nbsp;</td>
          <td class="titulos" width="210" valign="top">
			...
			Concluindo o curso com, no mínimo, 75% de aproveitamento o aluno recebe um certificado da sua capacitação atestado pela QiSat.<br><br><br>
