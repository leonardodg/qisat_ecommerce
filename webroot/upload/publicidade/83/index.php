...
<html>
<head>
<title>Série Tecnologia do Concreto</title>
...
<body>
<div align="center" style=" font-family:Arial, Helvetica, sans-serif; font-size:10px; color:#333333; margin:auto; padding-bottom:3px; padding-top:3px;">Caso não esteja visualizando o e-mail abaixo, <a href="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/index.php?preview=1&produtoid=257&folder=83" target="_blank" style="color:#015DA2;">CLIQUE AQUI</a>.</div>
<table width="780px" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px #CDD8E0"><tr><td>
<table width="780" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/convite_serie_02.png" border="0"></td>
	</tr>
    <tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/convite_serie_03.png" border="0"></td>
	</tr>
	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/convite_serie_04.png" border="0"></td>
	</tr>
	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/convite_serie_05.png" border="0"></td>
	</tr>
    	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/convite_serie_06.png" border="0"></td>
	</tr>
	<tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
  <tr>
    <td rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/convite_serie_07.png" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    	...
    	?></td>
    <td width="61" rowspan="2"><a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=257" target="_blank"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/botoes.gif" border="0"></a></td>
    </tr>
    
  <tr>
    <td height="40" valign="top" style="padding-left:8px;"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/cargahoraria.gif"  usemap="#capitulo1" border="0"></td>
    </tr>

<tr>
    <td rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/convite_serie_09.png" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=1;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
    <td height="40" valign="top" style="padding-left:8px;"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/cargahoraria.gif" border="0"></td>
    </tr>
    <tr>
    <td rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/convite_serie_10.png" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=2;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
    	...
    	?></td>
    <td width="61" rowspan="2"><a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=257" target="_blank"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/botoes.gif" width="22" height="48" border="0"></a></td>
    </tr>
  ...
  <tr>
	...
	<tr>
		<td height="80" valign="bottom">
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/convite_serie_11.png" alt="" usemap="#SaibaMais" border="0"></td>
	</tr>
	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/convite_serie_12.png" border="0"></td>
	</tr>
	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/83/images/convite_serie_13.png" usemap="#rodape" border="0"></td>
	</tr>
</table>
</td></tr></table>
</body>
...
<map name="SaibaMais">
  <area shape="rect" coords="234,10,548,59" href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=257" target="_blank">
</map>
<map name="rodape">
