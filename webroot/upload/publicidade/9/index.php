...
.topicos {
	font-weight: bold; font-size: 11px; color: #ff5a00; line-height: 16px; font-family: Arial, Helvetica, sans-serif;
}
.titulos {
...
<body>
	<table cellSpacing=0 cellPadding=0 width=649 align=center border=0>
		...
		<tr>
		  ...
		  O curso tem como objetivo proporcionar aos profissionais e estudantes de engenharia, arquitetura e técnicos de áreas relacionadas que atuam ou pretendem atuar na elaboração de projetos, conhecimento sobre os principais recursos do software QiElétrico, software para elaboração de projetos de instalações elétricas prediais de baixa tensão, pertencente a família QiBuilder.</TD>
		</tr>
		<tr>
			<td bgcolor="#FFFFFF">
        ...
        <tr>
          <td class="titulos" width="160" valign="top"><img height=19 width="125" src="<?php echo $linkConvite;?>images/tit_topico.gif" />
			...
			<span class="topicos">&#9679; </span>Lançamento de pontos de luz, interruptores e tomadas<br />
			<span class="topicos">&#9679; </span>Lançamento e definição de quadros e circuitos<br />
			<span class="topicos">&#9679; </span>Lançamento automático e manual dos condutos<br />
			<span class="topicos">&#9679; </span>Procedimentos para lançamento da fiação<br />
			<span class="topicos">&#9679; </span>Dimensionamento da fiação<br />
			<span class="topicos">&#9679; </span>Geração de legendas, diagramas unifilares e quadros de cargas <br />
			<span class="topicos">&#9679; </span>Geração de plantas finais <br />
            <span class="topicos">&#9679; </span>Cadastramento de peças e geração de listas de materiais<br /></TD>
          <TD width=11>&nbsp;</TD>
          <TD class="titulos" width="200" valign="top">
    		...
    		if($precoPromocional != $preco){
    			...
    			echo 'por ' . $moeda . ' <span style="font-size:25px; color:#ff5a00"><strong>' . $precoPromocional . '</strong></span><br>';
    	...
    	?>  				
				<BR>
			<img width="111" height="32" border="0" src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/9/images/bandeiras.gif" alt="Bandeiras Visa e Mastercard e Boleto Eletrônico" /></div></TD></TR>
        <TR>
          <td colspan="3" align="center"><a href="http://www.altoqi.com.br/software/qibuilder/projeto-de-instalacao-eletrica/qieletrico" target="_blank"><img width="204" height="35" border="0" alt="Conheça o Software" src="<?php echo $linkConvite;?>images/conheca.gif" useMap=#Map3></a>
          <a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=150<?php echo $info_curso_presencial;?>" target="_blank"><img width="204" height="35" border="0" alt="Conheça o Software" src="<?php echo $linkConvite;?>images/inscrevase.gif" useMap=#Map3></a></td>
        </TR>
				</TABLE></TD>
		</TR>
		<tr bgcolor="#FFFFFF">
