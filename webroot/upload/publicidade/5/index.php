...
<body>
	<table cellSpacing=0 cellPadding=0 width=649 align=center border=0>
        ...
        <TR>
          <td colspan="3" align="center"><a href="http://www.altoqi.com.br/software/projetos-eletricos/lumine-v4" target="_blank"><img width="204" height="35" border="0" alt="Conheça o Software" src="<?php echo $linkConvite;?>images/conheca.gif" ></a><a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=43<?php echo $info_curso_presencial;?>" target="_blank"><img width="204" height="35" border="0"  src="<?php echo $linkConvite;?>images/inscrevase.gif" ></a></td>
        </TR>
				</TABLE></TD>
		</TR>
		<tr bgcolor="#FFFFFF">
