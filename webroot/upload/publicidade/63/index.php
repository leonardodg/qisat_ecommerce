...
<table align="center" id="Table_01" width="780" cellpadding="0" cellspacing="0" style="border: solid 1px #E0E0D4">
	<tr>
		<td>
  ...
  <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/63/images/convite_curso_09.gif" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    	...
    	?></td>
    <td width="61" rowspan="2"><a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=202" target="_blank"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/63/images/botoes.gif" border="0"></a></td>
    </tr>
    
  <tr>
    <td height="40" valign="top" style="padding-left:8px;"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/63/images/cargahoraria.gif"  usemap="#capitulo1" border="0"></td>
    </tr>

<tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/63/images/convite_curso_11.gif" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=1;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
    <td height="40" valign="top" style="padding-left:8px;"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/63/images/cargahoraria.gif" border="0"></td>
    </tr>
    <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/63/images/convite_curso_12.gif" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=2;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
    ...
    <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/63/images/convite_curso_13.gif" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=3;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
    ...
    <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/63/images/convite_curso_14.gif" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=4;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
    ...
    <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/63/images/convite_curso_15.gif" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=5;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
    ...
    <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/63/images/convite_curso_16.gif" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=6;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
    ...
    <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/63/images/convite_curso_17.gif" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=7;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
    ...
    <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/63/images/convite_curso_19.gif" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=8;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
    ...
    <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/63/images/convite_curso_20.gif" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=9;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
...
<map name="rodape">
  ...
  <area shape="rect" coords="47,42,293,76" href="http://www.qisat.com.br/" target="_blank">
</map>