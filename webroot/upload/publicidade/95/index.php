...
align="center">Caso não esteja visualizando o e-mail abaixo, <A style="COLOR: #015da2" href="http://www.qisat.com.br/ecommerce/catalogo/arquivos/9/index.php?niveis=1" target=_blank>CLIQUE AQUI</A>.</DIV>
...
<TABLE border=0 cellSpacing=0 cellPadding=0 width=700 bgColor="#ffffff" align="center">
  ...
  <TR>
    <TD height=12 width=700 align="center"><IMG src="http://public.qisat.com.br/campanhas/e-convites/2015/11_1720/images/linha.gif"></TD></TR>
  <TR>
    ...
    <TD>
      <TABLE border=0 cellSpacing=1 cellPadding=0 width=680 bgColor="#ffffff" align="center" style="FONT-FAMILY: Tahoma, Arial, Helvetica, sans-serif; FONT-SIZE: 11px">
        <TR style="COLOR: #555555; FONT-SIZE: 12px">
          ...
          <TD bgColor="#e1e2e3" width=90 align="center" style="FONT-SIZE: 11px">PROMOCIONAL</TD>
          <TD bgColor="#e1e2e3" width=100 align="center"><SPAN style="FONT-SIZE: 11px">DEMONSTRATIVO</SPAN></TD></TR>
        <TR>
        <tr>
    <td height="16" bgcolor="#ecedee" style="padding-left:15px; text-align:left"><a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=172" target="_blank">Curso Software QiElétrico a distância</a></td>
    <td align="center" bgcolor="#ecedee">R$ <?php echo retornarValor(172, "valortabela", "QiSat");?></td>
    <td align="center" bgcolor="#ecedee"><b>R$ <?php echo retornarValor(172, "valortabela", "QiSat");?></b></td>
    <td align="center" bgcolor="#ecedee" style="color:#555555; font-size:9px "><img src="http://public.qisat.com.br/campanhas/e-convites/2015/09_1658/images/seta.png" width="8" height="8">&nbsp;<a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=172" target="_blank">VER AULA</a></td>
  </tr>
          ...
          <td align="center" bgcolor="#ecedee"><b>R$ <?php echo retornarValor(14, "valordesconto", "QiSat");?></b></td>
        ...
        <TR>
          ...
          <td align="center" bgcolor="#ecedee"><b>R$ <?php echo retornarValor(28, "valordesconto", "QiSat");?></b></td>
        ...
        <TR>
          ...
          <TD bgColor="#ffffff" align="center" style="COLOR: #555555; FONT-SIZE: 9px" ></TD>
    ...
    <TD>
      <TABLE style="FONT-FAMILY: Tahoma, Arial, Helvetica, sans-serif; FONT-SIZE: 11px" border=0 cellSpacing=1 cellPadding=0 width=680 bgColor="#ffffff" align="center">
        <TR style="FONT-SIZE: 12px">
          ...
          <TD style="FONT-SIZE: 11px" bgColor=#e1e2e3 width=90 align="center">PROMOCIONAL</TD>
          <TD bgColor=#e1e2e3 width=100 align="center"><SPAN style="FONT-SIZE: 11px">DEMONSTRATIVO</SPAN></TD></TR>
          <TR>
        ...
        <TR>
          ...
          <TD style="FONT-SIZE: 9px" bgColor="#ffffff" align="center"></TD>
      ...
      <TABLE style="FONT-FAMILY: Tahoma, Arial, Helvetica, sans-serif; FONT-SIZE: 11px" border=0 cellSpacing=1 cellPadding=0 width=680 bgColor="#ffffff" align="center">
        <TR style="COLOR: #555555; FONT-SIZE: 12px">
          ...
          <TD style="FONT-SIZE: 11px" bgColor=#e1e2e3 width=90 align="center"><B>R$ <?php echo retornarValor(219, "valordesconto", "QiSat");?></B></TD>
          ...
          <TD style="FONT-SIZE: 11px" bgColor=#e1e2e3 width=90 align="center"><B>R$ <?php echo retornarValor(220, "valordesconto", "QiSat");?></B></TD>
        ...
        <TR style="COLOR: #555555; FONT-SIZE: 12px">
          ...
          <TD style="FONT-SIZE: 11px" bgColor=#e1e2e3 align="center"><B>R$ <?php echo retornarValor(207, "valordesconto", "QiSat");?></B></TD>
          ...
          <TD style="FONT-SIZE: 11px" bgColor=#e1e2e3 align="center"><B>R$ <?php echo retornarValor(173, "valordesconto", "QiSat");?></B></TD>
  ...
  <tr>
    <td height="16"  colspan="4" align="center" bgcolor="#ecedee"><a href="http://www.qisat.com.br/ecommerce/webstore.php" target="_blank">Clique aqui para conhecer os cursos de outras áreas.</a></td>
        ...
        <TR>
          <TD style="PADDING-LEFT: 15px" bgColor="#ffffff" height=6></TD>
          <TD style="PADDING-LEFT: 13px" bgColor="#ffffff" align="center"></TD>
          <TD style="COLOR: #555555; FONT-SIZE: 9px" bgColor="#ffffff" 
          align="center"></TD>
          <TD style="COLOR: #555555; FONT-SIZE: 9px" bgColor="#ffffff" 
...
<tr>
  ...
  <tr>
  	<td colspan="6"><img src="http://public.qisat.com.br/campanhas/e-convites/2015/08_1720/images/linha_rodape.gif" alt="Catálogo de Cursos QiSat" border="0" ></td>
  </tr>
   <tr>
