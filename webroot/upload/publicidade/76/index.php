...
<html>
<head>
<title>Série Desempenho de Edificações Habitacionais - Requisitos Gerais</title>
...
<body>
<div align="center" style=" font-family:Arial, Helvetica, sans-serif; font-size:10px; color:#333333; margin:auto; padding-bottom:3px; padding-top:3px;">Caso não esteja visualizando o e-mail abaixo, <a href="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/index.php?preview=1&produtoid=193&folder=76" target="_blank" style="color:#015DA2;">CLIQUE AQUI</a>.</div>
<table width="780px" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px #CDD8E0"><tr><td>
<table width="780" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_01.png"></td>
	</tr>
    <tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_02.png"></td>
	</tr>
	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_03.png"></td>
	</tr>
	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_04.png"></td>
	</tr>
	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_05.png"></td>
	</tr>
    	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_06.png"></td>
	</tr>
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
  <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_07.png" width="588" height="92" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    	...
    	?></td>
    <td width="61" rowspan="2"><a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=193" target="_blank"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/botoes.gif" border="0"></a></td>
    </tr>
    
  <tr>
    <td height="40" valign="top" style="padding-left:8px;"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/cargahoraria.png"  usemap="#capitulo1" border="0"></td>
    </tr>

<tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_08.png" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=1;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
    <td height="40" valign="top" style="padding-left:8px;"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/cargahoraria.png" border="0"></td>
    </tr>
    <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_09.png" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=2;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
    ...
    <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_10.png" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=3;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
    ...
    <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_11.png" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=4;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
    <td height="40" valign="top" style="padding-left:8px;"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/cargahoraria.png" border="0"></td>
     ...
     <tr>
    <td width="588" rowspan="2"><img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_12.png" border="0"></td>
    <td width="131" height="49" valign="bottom" style="color: #2D291E; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 16px; padding-left:11px; padding-bottom:3px;"><?php
    		$i=4;
			if($produtosSerie_precosPromocionais[$i] != $produtosSerie_precos[$i]){
    			echo 'de <span style="font-size:14px; text-decoration: line-through;">' . $produtosSerie_moedas[$i] . ' ' . $produtosSerie_precos[$i] . '</span><br>';
  ...
  <tr>
	...
	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_13.png" alt="" width="780" usemap="#SaibaMais" border="0"></td>
	</tr>
	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_14.png"></td>
	</tr>
	<tr>
		<td>
			<img src="http://www.qisat.com.br/ecommerce/produtos/convites/arquivos/76/images/convite_curso_15.png" usemap="#rodape" border="0"></td>
	</tr>
</table>
</td></tr></table>
</body>
...
<map name="SaibaMais">
  <area shape="rect" coords="233,21,547,70" href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=193" target="_blank">
</map>
<map name="rodape">
