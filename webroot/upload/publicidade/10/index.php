...
.topicos {
	font-weight: bold; font-size: 11px; color: #821400; line-height: 16px; font-family: Arial, Helvetica, sans-serif;
}
.titulos {
...
.valor2 {
	font-weight: bold; font-size: 22px; color: #821400; line-height: 16px; font-family: Arial, Helvetica, sans-serif;
}
.valorantigo {
...
<body>
	<table cellSpacing=0 cellPadding=0 width=649 align=center border=0>
		...
		<tr>
			<td width="200" rowspan="3" valign="top" bgcolor="#FFFFFF"><img
				src="<?php echo $linkConvite;?>images/lateral.png" alt="QiTec Cursos e Palestras Presenciais"
	...
	<table width="407" align="center">
		...
		<tr>
				...
				<td class="TxtCurso">QiEditor de Armaduras</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="Texto" bgcolor="#FFFFFF">O curso tem como objetivo proporcionar aos profissionais e estudantes de engenharia, arquitetura e técnicos que atuam ou pretendem atuar na área de estruturas conhecimento sobre os principais recursos do software QiEditor de Armaduras, software para edição e detalhamento de armaduras, pertencente a família QiBuilder.</TD>
		</tr>
		<tr>
			<td bgcolor="#FFFFFF">
	<table cellSpacing=0 cellPadding=0  align="center" border=0>
        <tr>
          <td class="titulos" width="160" valign="top"><img height=19 width="125" src="<?php echo $linkConvite;?>images/tit_topico.gif" />
			...
			<span class="topicos">&#9679; </span>Criação de armaduras, estribos e treliças<br />
			<span class="topicos">&#9679; </span>Edição e rebatimento das armaduras<br />
			<span class="topicos">&#9679; </span>Edição de segmento e divisão de barra<br />
			<span class="topicos">&#9679; </span>Faixas ortogonais e faixas alinhadas<br />
			<span class="topicos">&#9679; </span>Corte, cota ortogonal e cota alinhada<br />
			<span class="topicos">&#9679; </span>Conceitos gerais sobre relação de armadura e detalhamento<br />
			<span class="topicos">&#9679; </span>Atualizar Relação de aço e relação de aço parcial<br />
            <span class="topicos">&#9679; </span>Criação de detalhamentos<br />
            <span class="topicos">&#9679; </span>Exemplos práticos de aplicação<br /><br /></TD>
          <TD width=11>&nbsp;</TD>
          <TD class="titulos" width="200" valign="top">
			...
			<span class="topicos">&#9679; </span>Carga Horária: 12h / aula.<br />
        ...
        <TR>
          <td colspan="3" align="center"><a href="http://www.altoqi.com.br/software/projeto-estrutural/detalhamento-de-armaduras/qieditor-de-armaduras/" target="_blank"><img width="242" height="35" border="0" alt="Conheça o Software" src="<?php echo $linkConvite;?>images/conheca.gif" useMap=#Map3></a><a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=151<?php echo $info_curso_presencial;?>" target="_blank"><img width="166" height="35" border="0" alt="Conheça o Software" src="<?php echo $linkConvite;?>images/inscrevase.gif" useMap=#Map3></a><br/><br/></td>
        </TR>
			</TABLE></TD>
		</TR>
		<tr bgcolor="#FFFFFF">
...
<area shape=RECT target=_blank coords=10,11,190,114 href="http://www.qisat.com.br/ecommerce/produtos/category.php?id=10">
</map>
<map id=Map name=Map>
<area shape="RECT" target="_blank" coords="13,23,87,85" href="http://www.mntecnologia.com.br/">
<area shape=RECT target=_blank coords="259,31,397,50" href="http://www.qisat.com.br">
<area shape=RECT coords="282,51,368,70" href="mailto:qisat@qisat.com.br">
<area shape=RECT target=_blank coords="559,19,633,81" href="http://www.altoqi.com.br">
</map>
<map name="Map4">
<area shape="rect" coords="274,4,309,38" href="http://www.facebook.com/qisat" target="_blank" alt="QiSat no Facebook">
<area shape="rect" coords="314,4,347,38" href="http://br.linkedin.com/in/qisat" target="_blank" alt="QiSat no LinkedIn">
<area shape="rect" coords="347,5,380,39" href="http://twitter.com/qisat/" target="_blank" alt="Twitter QiSat">
<area shape="rect" coords="382,4,415,38" href="http://www.youtube.com/qisat/" target="_blank" alt="Canal QiSat no YouTube">
<area shape="rect" coords="419,4,452,38" href="http://www.qisat.com.br/contato/contato.php" target="_blank" alt="MSN QiSat">
</map>