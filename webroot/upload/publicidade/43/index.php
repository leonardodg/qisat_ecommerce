...
<title>Pacote de Cursos Instalações de Cabeamento Estruturado Predial</title>
<style type="text/css">
<!--
a:link {
	color: #015da2;
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; border: 1px solid #dbdbdb; ">
  ...
  <tr bgcolor="#eeeeee">
    <td colspan="2" align="left" valign="bottom" bgcolor="#e8e8e8" border="0" ><a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=127" target="_blank"><img src="images/PCCAB3.png" border="0" title="Pacote de Cursos Instalações de Cabeamento Estruturado Predial" /></a></td>
  </tr>
  <tr>
...
<img src="images/toque.png"/ style="padding-right:8px;">&nbsp;Curso Software Lumine V4 a distância<br/>
<img src="images/toque.png"/ style="padding-right:8px;">&nbsp;&nbsp;Curso Sistemas de Cabeamento Estruturado via internet<br/>
<img src="images/toque.png"/ style="padding-right:8px;">&nbsp;&nbsp;Curso Software Cabeamento Estruturado - Lumine V4 a distância<br/>
<br/><br/>
<a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=127" target="_blank" style="color:#333333">[...] Saiba mais</a><br/><br/></td>
        </tr>
      <tr style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold; color:#333333; padding-top:10px;">
        ...
        <img src="images/toque.png"/ style="padding-right:8px;">&nbsp;&nbsp;Acesso ao curso a qualquer momento e de qualquer lugar;<br/>
  		<img src="images/toque.png"/ style="padding-right:8px;">&nbsp;&nbsp;<strong>Fórum de discussões:</strong> é um espaço para debates e troca de experiências com outros participantes, sobre vários<br/><span style="padding-left:28px">temas propostos pelo curso;</span><br/>
  		<img src="images/toque.png"/ style="padding-right:8px;">&nbsp;&nbsp;<strong>Monitoria:</strong> O professor responde, por e-mail, às dúvidas sobre os conteúdos relacionados às aulas;<br/>
  		<img src="images/toque.png"/ style="padding-right:8px;">&nbsp;&nbsp;<strong>Biblioteca:</strong> Material de apoio para impressão ou download, além de materiais complementares e recomendações<br/> <span style="padding-left:28px">de sites e livros;</span><br/>
 		<img src="images/toque.png"/ style="padding-right:8px;">&nbsp;&nbsp;<strong>Ajuda:</strong> espaço para esclarecimento de dúvidas em relação ao conteúdo, às questões administrativas e<br/><span style="padding-left:28px">tecnológicas;</span><br/>
        <img src="images/toque.png"/ style="padding-right:8px;">&nbsp;&nbsp;<strong>Certificado:</strong> o aluno receberá ao final do curso um certificado de conclusão.<br/></td>
        </tr>
      <tr style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#333333; line-height:140%;">
        <td></td>
        <td height="100" align="center"><a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=127" target="_blank"><img src="images/bt_comprar.jpg" border="0"/ title="Comprar Pacote"></a></td>
        <td>&nbsp;</td>
      </tr>
    </table></td>
  </tr>
