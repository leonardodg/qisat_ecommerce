	...
	<table cellSpacing=0 cellPadding=0 width=649 align=center border=0>
		...
		<tr>
			...
			<td width="449" height="220" valign="top" bgcolor="#FFFFFF"><img
				...
				width="450" height="180" border="0" usemap="#Map4"> <map name="Map4">
		...
		<tr>
			<td class="Texto" bgcolor="#FFFFFF">
					Destinado a usuários iniciantes, este curso apresenta a 
					tecnologia do software AltoQi Hydros, abordando suas principais 
					características, funções, ferramentas, recursos e demais possibilidades 
					de utilização.
			</TD>
		</tr>
		<tr>
			<td bgcolor="#FFFFFF">
				<table cellSpacing=0 cellPadding=0 align="center" border=0>
					<tr>
						<td class="titulos" width="160" valign="top">
							<img height=19 width="125" src="<?php echo $linkConvite;?>images/tit_topico.gif" /> 
							<br /><br /> 
							<span class="topicos">&#9679; </span>
							Filosofia de lançamento orientada ao projeto como um todo.
							<br /> 
							<span class="topicos">&#9679; </span>
							Lançamento e acabamento de detalhes isométricos
							<br /> 
							<span class="topicos">&#9679; </span>
							Lançamento e acabamento de detalhes sanitários
							<br /> 
							<span class="topicos">&#9679; </span>
							Dimensionamento de tubulações de água e esgoto
							<br /> 
							<span class="topicos">&#9679; </span>
							Geração de listas de materiais do projeto
							<br /> 
							<span class="topicos">&#9679;</span>
							Verificação de perdas de carga
							<br /> 
							<span class="topicos">&#9679; </span>
							Geração de relatórios de cálculo e da visão tridimensional da tubulação
							<br /> 
							<span class="topicos">&#9679; </span>
							Geração de cortes e esquemas verticais da rede hidráulica e sanitária
							<br />
							<span class="topicos">&#9679; </span>
							Geração de plantas finais
							<br />
						</TD>
						<TD width=11>&nbsp;</TD>
						<TD class="titulos" width="200" valign="top">
							...
							<br /><br /> 
							<span class="topicos">&#9679; </span>
							Aula prática em microcomputador.<br />
							<span class="topicos">&#9679; </span>
							Carga Horária: 16h / aula.<BR>
							<span class="topicos">&#9679; </span>
							Direcionamento de 15 a 18 profissionais.
							<BR> <BR> <BR> 
							<img height="17" width="85" src="<?php echo $linkConvite;?>images/tit_certificado.gif" /> 
							<BR> <BR> 
							Com 75% de participação você recebe o certificado do curso até 30 dias após
							a data da edição. 
							<BR> <BR> <BR> 
...
<MAP id=Map3 name=Map3>
	...
	<AREA shape=RECT target=_blank coords=12,9,190,28
		href="http://www.altoqi.com.br/software/projetos-hidraulicos/hydros-v4">
</MAP>
