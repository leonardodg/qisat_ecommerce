...
<body>
<div align="center" style="font-size:10px; color:#333333; margin:auto; padding-bottom:10px;">Caso não esteja visualizando o e-mail abaixo, <a href="http://www.qisat.com.br/ecommerce/catalogo/arquivos/8/index.php?niveis=1" target="_blank" style="color:#015DA2;">CLIQUE AQUI</a>.</div>
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr style="font-size:12px; color:#555555;">
    ...
    <td width="90" bgcolor="#e1e2e3" align="center" style="font-size:11px;">PROMOÇÃO</td>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#ecedee"><b>R$ <?php echo retornarValor(12, "valordesconto", "QiSat");?></b></td>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#ecedee"><b>R$ <?php echo retornarValor(17, "valordesconto", "QiSat");?></b></td>
...
<tr>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#ecedee"><b>R$ <?php echo retornarValor(213, "valordesconto", "QiSat");?></b></td>
...
<table width="678" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" style="font-family:Tahoma, Arial, Helvetica, sans-serif; font-size:11px; color:#555555; ">
  <tr style="font-size:12px; color:#555555;">
    ...
    <td width="90" bgcolor="#ecedee" align="center" style="font-size:11px;"><b>R$ <?php echo retornarValor(125, "valordesconto", "QiSat");?></b></td>
  ...
  <tr style="font-size:12px; color:#555555;">
    ...
    <td width="90" bgcolor="#ecedee" align="center" style="font-size:11px;"><b>R$ <?php echo retornarValor(130, "valordesconto", "QiSat");?></b></td>
  ...
  <tr style="font-size:12px; color:#555555;">
    ...
    <td width="90" bgcolor="#ecedee" align="center" style="font-size:11px;"><b>R$ <?php echo retornarValor(176, "valordesconto", "QiSat");?></b></td>
  ...
  <tr style="font-size:12px; color:#555555;">
    ...
    <td width="90" bgcolor="#ecedee" align="center" style="font-size:11px;"><b>R$ <?php echo retornarValor(175, "valordesconto", "QiSat");?></b></td>
  ...
  <tr style="font-size:12px; color:#555555;">
    <td height="27" bgcolor="#ecedee" style="padding-left:15px;"><a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=173" target="_blank"><SPAN style="FONT-SIZE: 11px"><strong>Pacote de Cursos QiBuilder - Full via internet

</strong></span></a></td>
    <td width="90" bgcolor="#ecedee" align="center" style="font-size:11px;">R$ <?php echo retornarValor(173, "valortabela", "QiSat");?></td>
    <td width="90" bgcolor="#ecedee" align="center" style="font-size:11px;"><b>R$ <?php echo retornarValor(173, "valordesconto", "QiSat");?></b></td>
...
<tr>
  ...
  <tr>
  	<td colspan="6"><img src="http://public.qisat.com.br/campanhas/e-convites/2015/11_1718/images/linha_rodape.gif" border="0" ></td>
  </tr>
   <tr>
