...
<body>
<div align="center" style="font-size:10px; color:#333333; margin:auto; padding-bottom:10px;">Caso não esteja visualizando o e-mail abaixo, <a href="http://www.qisat.com.br/ecommerce/catalogo/arquivos/7/index.php?niveis=1" target="_blank" style="color:#015DA2;">CLIQUE AQUI</a>.</div>
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr style="font-size:12px; color:#555555;">
    ...
    <td width="90" bgcolor="#e1e2e3" align="center" style="font-size:11px;">PROMOCIONAL</td>
...
<tr>
    ...
    <td align="center" bgcolor="#ecedee">R$ <?php echo retornarValor(239, "valortabela", "QiSat");?></td>
     ...
     <td align="center" bgcolor="#ecedee" style="color:#555555; font-size:9px "><img src="http://public.qisat.com.br/campanhas/e-convites/2015/08_1716/images/seta.png" width="8" height="8">&nbsp;<a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=239" target="_blank" style="color:#23598c;">VER AULA</a></td>
  </tr>  <tr>
    <td height="16" bgcolor="#ecedee" style="padding-left:15px">
...
<tr>
  ...
  <tr style="font-size:12px; color:#555555;">
    <td height="27" bgcolor="#e1e2e3" style="padding-left:15px"><strong>SÉRIES DE CAPÍTULOS - TEÓRICO</strong></td>
    <td colspan="2" align="center" bgcolor="#e1e2e3" style="font-size:11px;">VALOR POR CAPÍTULO</td>
    <td width="100" bgcolor="#e1e2e3" align="center"><span style="font-size:11px;">DEMONSTRATIVO</span></td>
  </tr>
  <tr>
    <td height="16" bgcolor="#ecedee" style="padding-left:15px"><a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=202" target="_blank"><b>Série Concreto Armado - Requisitos para Desenvolvimento de Projetos de Edificações</b></a></td>
    <td colspan="2" align="center" bgcolor="#ecedee"></b>CONSULTAR</td>
     <td align="center" bgcolor="#ecedee" style="color:#555555; font-size:9px;"><img src="http://public.qisat.com.br/campanhas/e-convites/2015/08_1716/images/seta.png" width="8" height="8">&nbsp;<a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=202" target="_blank" style="color:#23598c;">CAPÍTULOS</a></td>
  </tr>
  <tr>
    ...
    <td colspan="2" align="center" bgcolor="#ecedee"></b>CONSULTAR</td>
     <td align="center" bgcolor="#ecedee" style="color:#555555; font-size:9px;"><img src="http://public.qisat.com.br/campanhas/e-convites/2015/08_1716/images/seta.png" width="8" height="8">&nbsp;<a href="http://www.qisat.com.br/ecommerce/produtos/info.php?id=153" target="_blank" style="color:#23598c;">CAPÍTULOS</a></td>
  </tr>
  <tr>
...
<tr>
    <td height="6" bgcolor="#FFFFFF" style="padding-left:15px"></td>
    <td width="87" align="center" bgcolor="#FFFFFF" style="padding-left:13px"></td>
...
<table width="680" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" style="font-family:Tahoma, Arial, Helvetica, sans-serif; font-size:11px; color:#555555; ">
  ...
  <tr style="font-size:12px; color:#555555;">
    ...
    <td width="90" bgcolor="#e1e2e3" align="center" style="font-size:11px;"><b>R$ <?php echo retornarValor(210, "valordesconto", "QiSat");?></b></td>
  ...
  <tr style="font-size:12px; color:#555555;">
    ...
    <td width="90" bgcolor="#e1e2e3" align="center" style="font-size:11px;"><b>R$ <?php echo retornarValor(211, "valordesconto", "QiSat");?></b></td>
  ...
  <TR style="COLOR: #555555; FONT-SIZE: 12px">
          ...
          <TD style="FONT-SIZE: 11px" bgColor=#e1e2e3 align="center"><B>R$ <?php echo retornarValor(208, "valordesconto", "QiSat");?></B></TD>
...
<tr style="font-size:12px; color:#555555;">
    ...
    <td width="90" bgcolor="#e1e2e3" align="center" style="font-size:11px;"><b>R$ <?php echo retornarValor(173, "valordesconto", "QiSat");?></b></td>
